...
<div class="back_to_site">
    ...
    <button type="button" class="btn btn-primary"><a href="{{ url('/admin/quest') }}">Вопросы</a></button>
        ...
        <tbody>
           @foreach($questions as $quest)
            <tr>
                ...
                <td>{{ $quest->text }}</td>
                <td>
    <form method="POST" action="{{ route('admin.destroy_quest', $quest->id) }}" style="display:inline;">
        @csrf
